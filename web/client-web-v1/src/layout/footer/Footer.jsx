...
const Footer = () => {
  return (
    <footer className={footerTheme.root}>
      <div
        className={`${footerTheme.container} ${theme.layout.sectionPadding}`}
      >
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className={`${footerTheme.text} mb-4`}>
              Your quantum leap into the world of literature. Discover, read,
          ...
          <div>
            ...
            <address className={`not-italic ${footerTheme.text} space-y-2`}>
              <p>123 Book Lane</p>
              ...
              <p>
                <a href="tel:+11234567890" className={footerTheme.link}>
                  (123) 456-7890
                </a>
              </p>
            </address>
        ...
        {/* Divider */}
        <div className={footerTheme.divider}></div>
