...
const BookSquareCard: React.FC<BookSquareCardProps> = ({ book, onTagClick }) => {
        ...
        <div className="flex-grow">
          ...
          <div className="flex items-center gap-2 text-sm mb-2">
            ...
            {book.authorId ? (
              ...
              <span className="font-medium text-sky-600">{book.author}</span>
            )}
            {book.published && (
